<%@ page language="java" contentType="text/html"%>
  ...
  <head>
    ...
    <link href="/filemei-1/assets/home/upload/upload.css" rel="stylesheet">
    <script src="/filemei-1/assets/home/upload/upload.js"></script>
...
<div class="headline">
  ...
  <div class="headline-left">
    <div class="button-right">
      <button class="signin-button" onclick="linkTrigger('/filemei-1/login')">Login</button>
    </div>
    <div class="button-left">
      <button class="signup-button" onclick="linkTrigger('/filemei-1/signup')">Sign Up</button>
    </div>
  </div>
</div>
<div class="wrapper">
  <div class="container">
    ...
    <div class="upload-container">
      <div class="border-container">          
          <form id="FilemeiUpload" action="/filemei-1/FilemeiUpload" method="post" enctype="multipart/form-data" class="hidden">
