...
for(Cookie cookie : cookies){
  if(cookie.getName().equals("filemei-1cookie")) seszion = cookie.getValue();
}
}
if(seszion.equals("null") || seszion.equals("") || seszion == null){ response.sendRedirect("/filemei-1/login/"); return;}
...
<head>
    ...
    <link href="/filemei-1/assets/warehouse/warehouse.css" rel="stylesheet">
    <script src="/filemei-1/assets/warehouse/warehouse.js"></script>
...
<div class="headline">
  <div class="headline-right">
    <a href="/filemei-1/home"><h1>filemei</h1></a>
  </div>
  ...
  <a href="http://localhost:8080/filemei-1/warehouse/">Warehouse</a>
  <a href="http://localhost:8080/filemei-1/warehouse/share.jsp">Share</a>
  <a href="http://localhost:8080/filemei-1/logoutware">Sign out</a>
  </div>
</div>
</div>
  </div>
  ...
  <div class="container-table">
    ...
    <thead>
        ...
        <tbody>
          ...
          <form id="userfileToUpload" action="/filemei-1/UserUpload" method="post" enctype="multipart/form-data" class="hidden">
